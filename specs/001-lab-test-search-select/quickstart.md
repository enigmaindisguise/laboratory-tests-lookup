...
|---|----------|-------|------------------|-----|
| 1 | Fuzzy search | Type `blood sugar` | `t-001` "Glucose (blood sugar)" appears among the matches | SC-001, FR-002 |
| 2 | Browse mode | Clear the search box | All 10 catalog items listed; list scrolls internally if it overflows | FR-005, FR-004 |
| 3 | No results | Type `zzzz` | "No results" message shown | FR-006 |
| 4 | Add & increment | Click "Add" on `t-001` twice | Section 2 shows `t-001` once with amount 2 | FR-007, scenario 2.5 |
